...
ascii_banner = pyfiglet.figlet_format("TeleSnos")
...
def complaint():
	...
	print(colored("[1] Виртуальный номер", "red"))
	print(colored("[2] Премиум","yellow"))
	print(colored("[3] Оскорбление","green"))
	print(colored("[4] Нарушение правил", "blue"))
	print(colored("[5] Cнос Сессий", "magenta"))
	print(colored("[6] Спам", "red"))
	print(colored("[7] Прайс", "yellow"))
	print(colored("[8] Накрутка", "green"))
	complaint_choice = input(colored("Введите причину сноса-> """))
